                        ...
                        <div class="sidebar-submenu">
                          <ul>
                            ...
                            <li class="sidebar-menu-item">
                              <a href="{{url('/items/')."/$subcat->slug"."?location=".request()->input('location')}}" class="{{@$subcategory->id == $subcat->id?'text-dark':''}}">{{ ucwords($subcat->name) }}<span>{{getAmount($subcat->totalAd())}}</span></a>
                            </li>
                            @else
                            <li class="sidebar-menu-item">
                              <a href="{{url('/items/')."/$subcat->slug"}}" class="{{@$subcategory->id == $subcat->id?'text-dark':''}}">{{ ucwords($subcat->name) }}<span>{{getAmount($subcat->totalAd())}}</span></a>
                            </li>
                            @endif
                ...
                <div class="list-item list--style">
                  ...
                  <div class="list-item__wrapper">
                    <div class="list-item__content">
                      <a href="{{url('/items/')."/$slug"."?location=".request()->input('location')}}" class="category text--base"><i class="las la-tag"></i> {{ ucwords($ad->subcategory->name) }}</a>
                      ...
                      <ul class="list-item__meta mt-1">
                        ...
                        <li>
                          ...
                          <a href="javascript:void(0)">{{ ucwords($ad->user->fullname) }} </a> @if($ad->user->profile_verified == 1) &nbsp;<i style="color:#43ced2 !important;" class="fas fa-check-circle"></i> @endif
                        </li>
                        <li>
