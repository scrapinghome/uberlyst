        ...
        <table class="table custom--table">
          ...
          <tbody>
            ...
            <tr>
                ...
                <!--<td><a class="btn btn-sm btn-info" style="background: #002046; color: #fff; border: none;" href="{{ url('/feedback?adid=' . $ad->id) }}" onclick="copyURI(event)">Copy Feedback URL</a></td>-->
