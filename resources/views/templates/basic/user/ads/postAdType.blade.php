            ...
            <div class="card border-1 shadow-sm p-4">
                ...
                <div class="card-body">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between"><a class="text--base" href="{{route('user.post.ad.category','jobs')}}">@lang('Jobs')</a> <i class="las la-angle-right mt-1"></i></li>
                        <li class="list-group-item d-flex justify-content-between"><a class="text--base" href="{{route('user.post.ad.category','community')}}">@lang('Community ')</a> <i class="las la-angle-right mt-1"></i></li>
                    </ul>
                </div>
            </div>
        </div>
