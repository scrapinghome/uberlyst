        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.users*',2)}} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item  {{menuActive('admin.users.profileUnverified')}}">
                                <a href="{{route('admin.users.profileUnverified')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Verification Request')</span>

                                    @if($profile_unverified_users_count)
                                        <span
                                            class="menu-badge pill bg--primary ml-auto">{{$profile_unverified_users_count}}</span>
                                    @endif
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item  {{menuActive('admin.location*')}}">
                    <a href="{{route('admin.location.divisions')}}" class="nav-link">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.ads*',3)}}">
                       <i class="menu-icon lab la-buysellads"></i>
                        <span class="menu-title">@lang('Manage Ad List')</span>
                        @if($pending_ad > 0)
                            <span class="menu-badge pill bg--primary ml-auto">
                                <i class="fa fa-exclamation"></i>
                            </span>
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.ads*',2)}} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.ads.published')}} ">
                                <a href="{{route('admin.ads.published')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Published')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.ads.unpublished')}} ">
                                <a href="{{route('admin.ads.unpublished')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Un published')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.ads.pending')}} ">
                                <a href="{{route('admin.ads.pending')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Pending')</span>
                                    @if($pending_ad > 0)
                                        <span class="menu-badge pill bg--primary ml-auto">{{$pending_ad}}</span>
                                    @endif
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.ads.featured')}} ">
                                <a href="{{route('admin.ads.featured')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Featured Ads')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.ad.promote*',3)}}">
                       <i class="menu-icon las la-bullhorn"></i>
                        <span class="menu-title">@lang('Promote Request')</span>
                        @if($pending_promotion > 0)
                            <span class="menu-badge pill bg--primary ml-auto">
                                <i class="fa fa-exclamation"></i>
                            </span>
                        @endif
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.ad.promote*',2)}} ">
                        <ul>

                            <li class="sidebar-menu-item  {{menuActive('admin.ad.promote.all')}}">
                                <a href="{{route('admin.ad.promote.all')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Request')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item  {{menuActive('admin.ad.promote.pending')}}">
                                <a href="{{route('admin.ad.promote.pending')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Pending')</span>
                                    @if($pending_promotion > 0)
                                        <span class="menu-badge pill bg--primary ml-auto">
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.ad.promote.accepted')}} ">
                                <a href="{{route('admin.ad.promote.accepted')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Accepted')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.ad.promote.rejected')}} ">
                                <a href="{{route('admin.ad.promote.rejected')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item  {{menuActive('admin.packages*')}}">
                    <a href="{{route('admin.packages')}}" class="nav-link">
                        <i class="menu-icon las la-rocket"></i>
                        <span class="menu-title">@lang('Manage Packages')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item  {{menuActive('admin.packages*')}}">
                    <a href="{{route('admin.buyer_requests')}}" class="nav-link">
                        <i class="menu-icon las la-rocket"></i>
                        <span class="menu-title">@lang('Buyer Reply Requests')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item  {{menuActive('admin.ad.reports*')}}">
                    <a href="{{route('admin.ad.reports')}}" class="nav-link">
                        <i class="menu-icon las la-flag"></i>
                        <span class="menu-title">@lang('Reported Ads')</span>
                        @if ($ad_report > 0)
                          <span class="menu-badge pill bg--primary ml-auto">{{$ad_report}}</span>
                        @endif
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item  {{menuActive('admin.advertisements*')}}">
                    <a href="{{route('admin.advertisements')}}" class="nav-link">
                        ...
                        <span class="menu-title">@lang('Manage Adscript')</span>
                    </a>
                </li>
