        ...
        <div class="col-xl-3 col-lg-5 col-md-5 mb-30">
            ...
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body p-0">
                    <div class="p-3 bg--white">
                        <div class="">
                            <img src="{{ getImage(imagePath()['profile']['user']['path'].'/'.$user->id_card,imagePath()['profile']['user']['size'])}}" alt="@lang('Profile Image')" class="b-radius--10 w-100">
                        </div>
                        <div class="mt-15">
                            <span class="text--small"><strong>Id Card</strong></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body p-0">
                    <div class="p-3 bg--white">
                        <div class="">
                            <img src="{{ getImage(imagePath()['profile']['user']['path'].'/'.$user->id_card_with_sign,imagePath()['profile']['user']['size'])}}" alt="@lang('Profile Image')" class="b-radius--10 w-100">
                        </div>
                        <div class="mt-15">
                            <span class="text--small"><strong>Id Card With Sign</strong></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-none-30">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--1 b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.users.ads',$user->id)}}" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-ad"></i>
                        </div>
                        <div class="details">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--18 b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.users.promoted.ads',$user->id)}}" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-bullhorn"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{$totalPromoted}}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('Total Promoted Ad')</span>
                            </div>
                        </div>
                    </div>
                </div><!-- dashboard-w1 end -->
