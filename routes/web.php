...
//     $services = App\Models\SubCategory::where('category_id', 11)->get();

//     foreach ($services as $service) {
//         $service->type = 4;
//         // $service->per_month = 9.99;
//         // $service->per_six_month = 49.99;
//         // $service->per_year = 99.99;
//         $service->save();
//     }
//     return 'Done';
// });
...
Route::namespace('Gateway')->prefix('ipn')->name('ipn.')->group(function () {
    ...
    Route::get('subscribe', 'stripe_v3\ProcessController@subscribe');
...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::get('users/profile-unverified', 'ManageUsersController@profileUnverifiedUsers')->name('users.profileUnverified');
        ...
        Route::get('user/verify/{id}', 'ManageUsersController@verify')->name('users.verify');
...
Route::name('user.')->prefix('user')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware(['checkStatus'])->group(function () {
            ...
            Route::get('post/ad/{type}/{subcat}', 'AdController@selectLocation')->name('post.ad.location');
            Route::get('post/ad/{type}/{subcat}/{location}', 'AdController@showAdForm')->name('post.ad.form');
            ...
            Route::get('verified-seller', 'UserController@verifiedSeller')->name('verified-seller');
            Route::get('subscription-plan', 'UserController@subscriptionPlan')->name('subscription-plan');
            
            Route::post('verified-seller', 'UserController@verifiedSellerStore');
            ...
            //   Subscription
            Route::get('subscription/{type}', 'UserController@subscription')->name('subscription');
...
Route::post('/buyer_request/submit/{id}', 'AdController@submit_buyer_request')->name('buyer_request.submit');
Route::get('admin/buyer_requests', 'Admin\AdManageController@buyerrequests')->name('admin.buyer_requests');


Route::get('feedback', 'UserController@feedback');
Route::post('/feedback', 'UserController@feedbackStore');
Route::get('/cookie/accept', 'SiteController@cookieAccept')->name('cookie.accept');
Route::get('items/{subcategory?}', 'SiteController@allAds')->name('ads');
Route::get('/', 'SiteController@allAds')->name('home');
...
Route::get('/our-pricing', 'SiteController@pricing')->name('pricing');
