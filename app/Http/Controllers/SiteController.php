...
class SiteController extends Controller
{
    ...
    public function faq()
    {
        $page_title = 'Frequently asked quetions';
    ...
    public function pricing()
    {
        ...
        if(auth()->check()){
           ...
           $subscription_per_year = !!DB::table('subscriptions')
            ...
            $subscription = $subscription_per_month ? 'Starters' : ($subscription_per_six_month ? 'Pro' : ($subscription_per_year ? 'VIP' : null));
        }
        
        return view($this->activeTemplate.'pricing',compact('page_title', 'subscription'));
    ...
    public function allAds(Request $request,$subcat = null)
    {
        ...
        return view($this->activeTemplate.'allAds',compact('page_title','ads','categories','divisions','subcategory','distrct','featuredAds'));
    }
