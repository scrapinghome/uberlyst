    ...
    public function boot()
    {
        ...
        view()->composer('admin.partials.sidenav', function ($view) {
            $view->with([
                ...
                'profile_unverified_users_count' => User::profileUnverified()->count(),
                ...
                'pending_promotion'    => AdPromote::where('status',0)->count(),
                'pending_ad'    => AdList::where('status',0)->count(),
                'ad_report'    => ReportAd::where('seen',0)->count(),
            ]);
        });
